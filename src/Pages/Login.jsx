      ...
      <div className="flex items-center justify-center p-4">
        ...
        <CardContent>
          <form
            onSubmit={async (e) => {
              ...
              if (!email || !password) {
                alert("Veuillez fournir votre email et mot de passe.");
                return;
              }
              try {
                ...
                if (!res.ok) {
                  ...
                  alert("Login failed: " + (text || res.statusText));
                  return;
                }
                // successful login — adjust redirect as needed
          ...
          >
            <div>
              ...
              <input
                ...
                type="email"
                required
                className="mt-1 block w-full rounded-sm shadow-sm focus:ring-2 focus:ring-indigo-500 px-3 py-1"
          ...
          <div>
            <button
              onClick={() => {
                // Redirect to your backend OAuth endpoint that starts Google sign-in
        ...
        <CardFooter>
          <div className="text-sm text-gray-600 w-full text-center">
            Vous n'avez pas de compte? <a href="/signup" className="text-indigo-600 hover:underline">Inscrivez-vous</a>
          </div>
        </CardFooter>
      </Card>
    </div>
